package com.ruinscraft.panilla.craftbukkit.v1_19_R2.io;
...
import com.ruinscraft.panilla.craftbukkit.v1_19_R2.nbt.NbtTagCompound;
            ...
            if (entity != null) {
                if (entity instanceof EntityItem) {
                    ...
                    if (failedNbtList.containsCritical()) {
                        throw new EntityNbtNotPermittedException(packet.getClass().getSimpleName(), false, failedNbtList.getCritical(), entityId, entity.s.getWorld().getName());
                    }

                    FailedNbt failedNbt = failedNbtList.findFirstNonCritical();

                    if (failedNbt != null) {
                        throw new EntityNbtNotPermittedException(packet.getClass().getSimpleName(), false, failedNbt, entityId, entity.s.getWorld().getName());
                    }
                }
            }
        }
